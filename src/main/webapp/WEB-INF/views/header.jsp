...
<meta property="og:url"
	content="http://www.acebed.com:80/product/sleep-care/smart-sleeve/index.do"
	id="og-url-value" />
		...
		<header data-swiftype-index="false">
			...
			<nav>
				<div class="gnb_section gnb1">
					<div class="one_dep">
						<div>
							<a href="/product/bed/frame/list.do"> <span class="one">회원관리</span>
								<span>user</span>
							</a>
							<div class="two_dep">
					...
					<div class="one_dep">
						<div>
							<a href="https://www.acebed.com/product/furnture/roomset/list.do">
								<span class="one">제품관리</span> <span>Product</span>
							</a>
							<div class="two_dep">
								<a
					...
					<div class="one_dep">
						<div>
							<a href="javascript:"> <span class="one">주문관리</span> <span>Order</span>
							</a>
							<div class="two_dep">
					...
					<div class="one_dep">
						<div>
							<a href="/product/sleep-care/main/index.do"> <span
								class="one">재고 및 매출</span> <span>Inventory</span>
							</a>
							<div class="two_dep">
