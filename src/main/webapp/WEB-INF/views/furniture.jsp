...
<html lang="ko">
    <head>
        ...
        <meta property="og:url" content="http://www.acebed.com:80/product/furnture/roomset/list.do?pageIndex=1&listCnt=12&listType=1&ordType=&detailsKey=&q=" id="og-url-value" />
        <meta property="og:image" content="http://www.acebed.com:80/common/images/sns-share-thumbnail.jpg" id="og-image-value" />
        	<meta property="og:title" content="룸 세트" id="og-title-value" />
        	<meta property="og:description" content="에이스침대의 공식 홈페이지 입니다." id="og-description-value" />

        <meta itemprop="url" content="http://www.acebed.com:80/product/furnture/roomset/list.do?pageIndex=1&listCnt=12&listType=1&ordType=&detailsKey=&q=" id="schema-url-value" />
        ...
        <!-- //swiftype 검색 메타태그 -->
		<meta class="swiftype" name="top_menu" data-type="string" content="가구" />
		<meta class="swiftype" name="child_menu" data-type="string" content="룸 세트" />
		<meta class="swiftype" name="title" data-type="string" content="가구 > 룸 세트" />
...
<!-- Google tag (gtag.js) -->
    	...
    	<jsp:include page="header.jsp" />
			...
			<div class="head_div visual">
                        <p class="vs vs4"></p><!-- 비주얼 이미지마다 클래스 다르게 붙음 (vs1, vs2 ...)  -->
                        <h2 class="titleH1">룸 세트</h2>
                    </div>
                    <div class="content_div" data-controller="controller/ps/PSProductListCtrl" id="trgtTop">
						<form id="frmSearch" name="frmSearch" method="post" action="" data-csrf-key="VNZ0RoImXdHDrRvegJeG">
	                                ...
	                                <div class="pro_search">
	                                    ...
	                                    <div class="search_div">
	                                        <p class="search_input">
	                                        	<input type="text" id="q" name="q" value="" maxlength="30" placeholder="검색어를 입력하세요" autocomplete="off" data-top-menu="가구" data-child-menu="룸 세트" />
	                                    ...
	                                    <div class="acco_area" id="srchFltrArea">
	                                        <div class="acco_div">
                                  			...
                                  			<label for="typeCd_1">협탁</label>
                                  		</p><p class="chk_txt">
                                  			<input type="checkbox" id="typeCd_2" name="typeCd" value="TYPE020"  />
                                  			<label for="typeCd_2">거울</label>
                                  		</p><p class="chk_txt">
                                  			<input type="checkbox" id="typeCd_3" name="typeCd" value="TYPE030"  />
                                  			<label for="typeCd_3">서랍장&화장대</label>
                                  		</p><p class="chk_txt">
                                  			<input type="checkbox" id="typeCd_4" name="typeCd" value="TYPE090"  />
                                  			<label for="typeCd_4">기타</label>
                                  		</p></div>
	                                            </div>
	                                        </div>
	                                        <div class="acco_div">
	                                        ...
	                                        <input type="checkbox" id="clrGrpSeq_9" name="clrGrpSeq" value="8"  />
	                                        <label for="clrGrpSeq_9">따뜻한</label>
	                                    </div></div>
	                                            </div>
	                                        </div>
	                                    </div>
			...
			<div class="quick_area" data-swiftype-index="false">
            	<div class="quick_con">
                	<div class="like_div" style="display:none">
                    	...
                    	<form action="" data-csrf-key="VNZ0RoImXdHDrRvegJeG">
