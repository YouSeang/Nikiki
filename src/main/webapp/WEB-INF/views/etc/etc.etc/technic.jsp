...
<html lang="ko">
    <head>
        ...
        <meta property="og:url" content="http://www.acebed.com:80/bed-science/technology/index.do" id="og-url-value" />
        <meta property="og:image" content="http://www.acebed.com:80/common/images/sns-share-thumbnail.jpg" id="og-image-value" />
        	<meta property="og:title" content="기술력" id="og-title-value" />
        	<meta property="og:description" content="에이스침대의 공식 홈페이지 입니다." id="og-description-value" />

        <meta itemprop="url" content="http://www.acebed.com:80/bed-science/technology/index.do" id="schema-url-value" />
		...
		<meta class="swiftype" name="child_menu" data-type="string" content="기술력" />
		<meta class="swiftype" name="title" data-type="string" content="침대과학 > 기술력" />
...
<!-- Google tag (gtag.js) -->
			...
			<div class="tech_div" data-controller="controller/bs/bsd/BSDTechnologyViewCtrl">
	           	<div class="sub_vis window_load">
	                <div class="bg_img" style="background-image:url('https://www.acebed.com/common/images/sub-vis-tech-bg1.jpg');"></div>
	                <div class="txt_div">
	                    <p class="txt1">기술력</p>
	                    <p class="txt2">
	                        최고 소재와 최신 기술의 완벽한 조화로 세계 최고의 수면과 표면부의 안락감을 제공하기 위한 에이스의 노력! <br />보이지 않는 침대과학이 당신의 아침을 바꿉니다.
	                    </p>
	                </div>
	                    ...
	                    <div class="swiper-container">
	                        <div class="swiper-wrapper">
	                        	<div class="swiper-slide">
									<a href="javascript:" class="top_btn tabTechChild on" data-tab-name="system">
										<span>생산시스템</span>
									</a>
								</div>
								<div class="swiper-slide">
									<a href="javascript:" class="top_btn tabTechChild " data-tab-name="method">
										<span>METHOD</span>
									</a>
								</div>
								<div class="swiper-slide">
									<a href="javascript:" class="top_btn tabTechChild " data-tab-name="material">
										<span>MATERIAL</span>
									</a>
								</div>
	                        </div>
                ...
                <p class="tit">
           			생산시스템
           			<span class="txt">세계적 규모의 첨단 생산설비. <br class="only_web" />침대업계최초로 ISO-9001을 <br class="only_mob" />획득함으로써 침대 수준을 한 차원 더 높였습니다.</span>
                </p>
            </div>
			<div class="sticky_div">
	            <div class="sticky_inner">
	                <div class="background_wrap">
	                    <div>
	                        <div class="back ba1">
	                            <div class="img">
	                                <p class="dim"></p>
	                                <div class="copy_txt_div">
	                                    <div class="inner">
	                                        <p class="tit">매트리스 생산 시스템</p>
	                                        <p class="sub_tit1">최고의 설비가 최고의 침대를 만듭니다.</p>
	                                        <p class="sub_tit2">
	                                            스프링 제조에서 매트리스 포장에 이르는 전 공정을<br />
	                                            자동화한 생산 시스템은 가장 위생적인 환경에서<br />
	                                            최고의 제품을 한치의 오차도 없이 생산하고 있습니다.
	                                        </p>
	                                    </div>
	                                </div>
	                            </div>
	                        ...
	                        <div class="back ba2">
	                            <div class="img">
	                                ...
	                                <div class="copy_txt_div">
	                                    <div class="inner">
	                                        <p class="tit">소재 생산 시스템</p>
	                                        <p class="sub_tit1">최고의 품질을 위해 중요 소재는 <br />직접 생산합니다. </p>
	                                        <p class="sub_tit2">
	                                            소재의 차이가 곧 품질의 차이라 말할 수 있는 <br />에이스침대의 품질 철학은 소재생산에서도 <br />그 특별함을 확인할 수 있습니다.
	                                        </p>
	                                    </div>
	                                </div>
	                            </div>
	                        ...
	                        <div class="back ba3">
	                            <div class="img">
	                                ...
	                                <div class="copy_txt_div">
	                                    <div class="inner">
	                                        <p class="tit">프레임 생산 시스템</p>
	                                        <p class="sub_tit1">최고의 생산설비는 목공제조에도 이어집니다.</p>
	                                        <p class="sub_tit2">
	                                            최고를 향한 에이스의 열정은 프레임 제조라인에도 이어집니다. <br />최고의 소재 선택부터 연마, 도장, 금형까지 <br />최고 품질의 에이스가 완성됩니다.
	                                        </p>
	                                    </div>
	                                </div>
	                            </div>
	                ...
	                <div class="flow_div1 img_flow scroll_motion">
	                    <div class="img_flow_div">
	                        <div class="inner">
	                            <div class="flow_con">
	                                <div class="m_copy_txt_div">
	                                    <div class="inner">
	                                        <p class="tit">매트리스 생산 시스템</p>
	                                        <p class="sub_tit1">최고의 설비가 최고의 침대를 만듭니다.</p>
	                                        <p class="sub_tit2">
	                                ...
	                                <div class="con">
	                                    <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img1-1.jpg" alt="" /></p>
	                                    <p class="tit">오토컴 공법 제조 공정</p>
	                                    <p class="txt">
	                                        첨단 무인생산 시스템이 적용되어 최고 품질의 <br />매트리스를 자동으로 조립해 주는 생산 공정입니다.
	                                    </p>
	                                </div>
	                                <div class="con">
	                                    <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img1-3.jpg" alt="" /></p>
	                                    <p class="tit">이중 열처리기</p>
	                                    <p class="txt">
	                                        스프링판 전체를 섭씨 300도에서 약 12분 동안 <br />특수 열처리하여 매트리스의 탄력 강화 및 처짐을 <br />방지하는 시스템 입니다.
	                                    </p>
	                                </div>
	                            </div>
	                        </div>
	                ...
	                <div class="flow_div2 img_flow scroll_motion">
	                    <div class="img_flow_div">
	                        <div class="inner">
	                            <div class="flow_con">
	                                <div class="m_copy_txt_div">
	                                ...
	                                <div class="con">
	                                    <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img2-1.jpg" alt="" /></p>
	                                    <p class="tit">최고의 품질을 위한 고품격 섬유소재를 <br />직접 생산하는 최첨단 소재 압축라인</p>
	                                    <p class="txt">
	                                        최상의 탄력과 내구성을 자랑하는 에이스의 품질은 최고의 내장재가 있기에 가능합니다. <br />세계최고의 품질을 실현하기 위해 다양한 기능의 섬유소재를 직접 생산합니다.
	                                    </p>
	                                </div>
	                                <div class="con">
	                                    <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img2-2.jpg" alt="" /></p>
	                                    <p class="tit">완벽한 편안함을 위한 최고급 스펀지 생산 <br />최첨단 폴리우레탄 폼 라인</p>
	                                    <p class="txt">
	                                        누웠을 때 느껴지는 에이스의 완벽한 편안함의 비밀은 바로 에이스가 직접 생산하는 최고급 스펀지에 있습니다. <br />세계최고의 편안함을 위해 최고급 스펀지를 직접 생산합니다.
	                                    </p>
	                                </div>
	                            </div>
	                        </div>
	                ...
	                <div class="flow_div3 img_flow scroll_motion">
	                    <div class="img_flow_div">
	                        <div class="inner">
	                            <div class="flow_con">
	                                <div class="m_copy_txt_div">
                                    ...
                                    <div class="con">
                                        <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img3-2.jpg" alt="" /></p>
                                        <p class="tit">연속자동다단계 도장설비</p>
                                        <p class="txt">
                                            경화형 특수 도료를 사용하여 제품의 표면에 고성능 도막을 형성하는 도장설비로 다단계 자동 컨베어 라인에 의한 대량생산 및 신속작업이 가능합니다. 또한 고압 U.V램프에 의한 신속한 건조작업이 특징입니다.
                                        </p>
                                    </div>
                                    <div class="con">
                                        <p class="img"><img src="https://www.acebed.com/common/images/SCI-004-01-flow-img3-3.jpg" alt="" /></p>
                                        <p class="tit">고주파 곡형가공 열압기</p>
                                        <p class="txt">
                                            고주파 유도 가열 응용 창치 및 여러 형상의 금형을 이용하여 다양한 형태의 입체 곡면 성형 제품을 생산할 수 있고, 프레스, 금형(목형),고주파 기술이 융합되어 최고급 품질의 제품을 생산하는 기계입니다.
                                        </p>
                                    </div>
	                            </div>
	                        </div>
