...
<meta property="og:url"
	content="http://www.acebed.com:80/ace-story/review/view.do?listCnt=9&pageIndex=1&photoYn=&stressYn=&strlPtYn=&prchsPrpsCd=&wdngYn=&detailsKey=27547&searchTerm=&review_ch=&orderType=3"
	id="og-url-value" />
...
<meta class="swiftype" name="image" data-type="enum"
	content="https://www.acebed.com/image/2024/7/24070301444169915711.jpg" />
<!-- swiftype 검색 메타태그// -->
			...
			<div class="subCon">
				...
				<form id="frmReview" name="frmReview" method="post" action="delete">
					<div class="content_div"
						data-controller="controller/bm/BMBoardCtrl" data-info="Y">
						<div class="btn_div small right inner"></div>
						<div class="review_view">
							<div class="part2">
								<p class="float">
									<strong>작성일</strong> <span><c:out
											value="${review.createdAt}" /></span>
								</p>
								<p>
									<strong>작성자</strong> <span><c:out
											value="${review.userName}" /></span>
								</p>
							</div>
							<div class="part4" data-swiftype-name="content"
								data-swiftype-type="text">
								<c:out value="${review.content}" />
								<c:forEach var="image" items="${review.images}">
									<p class="img">
										<img
											src="<c:out value="./libraryUploadImg2/${image.imageUrl}" />"
											alt="리뷰 이미지" />
									</p>
								</c:forEach>
							</div>
							<div class="chose_div">
								<a href="javascript:" class="unit btnRcmd"
									data-seq="${review.reviewId}" data-rcmdYn="N">
									<div class="circle">
										<div>
											<img
												src="https://www.acebed.com/common/images/like2_icon.png"
												alt=""> <img
												src="https://www.acebed.com/common/images/like2_icon_on.png"
												alt="">
										</div>
		...
		<div class="quick_area" data-swiftype-index="false">
			<div class="quick_con">
				...
				<div class="catalogue">
					...
					<a href="https://www.acebed.com/customer/prdct-manual/index.do"
						class="txt_btn t2"><span>카탈로그 다운로드</span></a>
				</div>
				<div class="menu_link">
					<a href="https://www.acebed.com/experience/mattress/index.do"
						class="find_prod"><span>나에게 맞는 <br />매트리스 찾기
					</span></a> <a href="https://www.acebed.com/store/guide/index.do"
						class="info_store"><span>매장 안내</span></a> <a
						href="https://acebedmall.co.kr" target="_blank" class="ace_mall"><span>에이스몰
							<strong>바로가기</strong>
					</span></a>
				</div>
			</div>
