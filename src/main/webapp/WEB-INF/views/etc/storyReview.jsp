...
<meta property="og:url"
	content="http://www.acebed.com:80/ace-story/review/list.do?listCnt=9&pageIndex=1&photoYn=&stressYn=&strlPtYn=&prchsPrpsCd=&wdngYn=&detailsKey=&searchTerm=&review_ch=&orderType=3"
	id="og-url-value" />
...
<script type="text/javascript">
    function checkLogin() {
        ...
        if (!email) {
            if (confirm("로그인 이후 이용할 수 있습니다. \n로그인 페이지로 이동하시겠습니까?")) {
                window.location.href = "./loginView"; // 로그인 페이지로 리다이렉트
            }
            return false;
        }
        return true;
...
<div id="content" data-swiftype-name="body" data-swiftype-type="text"
	...
	<div class="subCon">
		...
		<div class="swiper reviewSwiper"
			data-controller="controller/as/asd/ASDBestReviewCtrl">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2024/3/24032711533154486220.jpeg"
							alt="">
						...
						<div class="slide-desc">
							...
							<p class="txt2">
								...
								이사하면서 침대 새롭게 사려고 여기저기 돌아다니다 종착지가 롯백동탄 에이스였어요! 레드로 맘먹고 백화점도 가보자해서
								갔다가 로얄80 은 백화점 라인이었는데 레드보다 훨씬 좋아서 바로 결정했어요!^^ 잠은 좋은 매트리스에서 자야
								한다고 매트리스가 좋으니 잠자리가 달라졌어요. 프레임도 아르노 투로 같이 샀는데 단점은 충전기를 양쪽으로 젠더는
								따로 준비해야 ...
							</p>
							<p class="hashtags">
								<span>#신혼부부추천</span> <span># LED조명침대</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=26079"
								onclick="brvCtrl.reviewCnt(31)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2024/3/24032711475226098181.jpg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								안녕하세요<br />신혼침대 에이스에서 구매하고<br />2달 동안 만족스럽게 사용중입니다<br /> <br />자다가
								화장실 갈 때 <br />간편하게 조명을 쓸 수 있으면 좋겠다 싶어서<br />호텔식프레임으로 알아봤고
								1164프레임으로 골랐어요<br />조명은 좌우로 잘 돌아가서 편리하고 <br />조명 밝기도 3단으로
								조절가능해요<br />무엇보다 양옆에 콘센트와 usb 단자가 있어서 <br />아주 편리하답니다<br />선반이...
							</p>
							<p class="hashtags">
								<span>#호텔형침대</span> <span># 신혼부부추천</span> <span># LED조명침대</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=25694"
								onclick="brvCtrl.reviewCnt(30)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2024/3/24032711531889739165.jpg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								신랑은 작은방에서 자는데 그저 그런 매트리스를 샀더니 반 년 만에 매트리스가 꺼져버렸어요...<br />그래서
								이왕 사는거 나중에 첫째 쓸 것 같이 생각해서<br />좋은 침대를 사자! 해서 침대를 사러 나갔는데<br />바로
								집 앞에 &#39;이천스퀘어점&#39; 이 오픈을 해서 가게되었습니다.<br /> <br />제일 마음에 들었던
								점은<br />우리가 원하는 디자인에 따라, 원하는 기능에 따라...
							</p>
							<p class="hashtags">
								<span>#CF침대</span> <span># LED조명</span> <span># 기능성침대</span> <span>#
									아트월컨셉</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=25862"
								onclick="brvCtrl.reviewCnt(29)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2023/6/23061203324644657891.jpeg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								너무 잘 쓰고 있는 에이스 침대!<br />구매는 롯데백화점 안산점에서 했어요. 에이스랑 타업체 돌아다녔는데
								매트리스도 에이스가 편하고 매니저님께서 저희에게 맞는걸로 추천을 너무 잘 해주셔서 에이스에서 구매하게 됐어요~!<br />프레임은
								부클 관리가 어려울 것 같아서 가죽이나 나무 프레임을 구매할 생각이었어요. 근데 부클 프레임이 너무 예뻐서<br />관리
								방법을 여쭤보니까 ...
							</p>
							<p class="hashtags">
								<span>#신혼침대</span> <span># 쿠션형침대</span> <span># 패브릭침대</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=23041"
								onclick="brvCtrl.reviewCnt(25)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2023/3/23031401594076513459.jpeg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								신혼침대로 구매하게되었어요 :)<br />만삭 임산부라 허리통증도있고 원래 침대에 예민한편이라 여기저기
								다른침대들도 보고 누워봤는데 이 매트리스는 눕자마자 아 이건내꺼다 ! 싶어서 1초의 고민도없이 바로 구매했어요<br />프레임도
								제가생각했던 디자인의 깔끔한 프레임이있어서 같이 구매하게되었습니다 같이 디자인골라주신 사장님도 너무친절하게 설명도
								잘해주셔서 고민없이 구매했...
							</p>
							<p class="hashtags"></p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=21536"
								onclick="brvCtrl.reviewCnt(24)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2024/3/24032711390920441234.jpeg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								새집을 분양받아 이사하면서 제일 고심했던건 <br />바로 나의 침대!!였어요~<br />나의 로망을 실현해줄
								제품을 찾고 있었는데 홈페이지에서 본 바로 그 제품!!! <br /> <br />너무 과하지 않고 깔끔하고
								예쁜데 충전, 조명, 콘센트로 실용적이기 까지 한 침대라…다른 매장은 보지도 않고 바로 구매했어요. <br />게다가
								제가 본 이제품이 제일 신상에 대로변에 가장 잘 보이는 메인...
							</p>
							<p class="hashtags">
								<span>#호텔형침대</span> <span># 신혼부부추천</span> <span># LED조명침대</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?detailsKey=26038"
								onclick="brvCtrl.reviewCnt(28)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-wrap">
						<img
							src="https://www.acebed.com/image/2024/3/24032712011354180518.jpg"
							alt="">
						<!-- <img src="/common/images/slide-img.jpg" alt="" /> -->
						<div class="slide-desc">
							<div class="desc-head">
							...
							<p class="txt2">
								<!-- 2021-11-22 수정 후기 내용 200자까지 노출 나머지 ...으로 대체 -->
								매장에는 없는 모델이었지만 인터넷으로 찾아보고 반신반의하며 구매한 모델이었어요<br />그런데 받자마자 웬걸 너무
								고급지고 예뻐요~~<br />설치해주시는 기사분도 시골만 다니셔서 이 모델은 처음본다고 신제품이냐고 엄청
								고급스럽다고 감탄을 하셨습니다~^^<br />분위기있고 예쁠뿐아니라 고급스럽고 차분한 느낌을 주네요 우선적으로는
								매트리스도 너무 편하고 잠도 솔솔 잘 오더라고요...
							</p>
							<p class="hashtags">
								<span>#신혼침대</span> <span># 쿠션형침대</span> <span># 패브릭침대</span>
							</p>
							<a
								href="https://www.acebed.com/ace-story/review/view.do?listCnt=9&pageIndex=1&photoYn=&stressYn=&strlPtYn=&prchsPrpsCd=&wdngYn=&detailsKey=25814&searchTerm=AMANDE&review_ch=&orderType=1"
								onclick="brvCtrl.reviewCnt(27)" class="view_more"><span>자세히
									보기</span></a>
						</div>
					</div>
				</div>
			...
			<div class="swiper-btn">
				<a href="javascript:" class="swiper-button-prev shape1" tabindex="0"
					...
					class="swiper-button-next shape2 swiper-button-disabled"
		...
		<div class="content_div"
			data-controller="controller/as/asb/ASBReviewListCtrl">
			<div class="review_list">
				<form id="frmSearch" name="frmSearch" method="get" action="">
					<input type="hidden" id="listCnt" name="listCnt" value="9" /> <input
						type="hidden" id="pageIndex" name="pageIndex" value="1" /> <input
						type="hidden" id="photoYn" name="photoYn" value="" /> <input
						type="hidden" id="stressYn" name="stressYn" value="" /> <input
						type="hidden" id="strlPtYn" name="strlPtYn" value="" /> <input
						type="hidden" id="prchsPrpsCd" name="prchsPrpsCd" value="" /> <input
						type="hidden" id="wdngYn" name="wdngYn" value="" /> <input
					...
					<div class="card-container">
						<c:forEach var="review" items="${reviews}" varStatus="status">
							<div class="card">
								<a href="./storyReviewDetail?reviewId=${review.reviewId}">
			...
			<div class="none_div" id="dataAreaN" style="display: none">
				검색결과가 없습니다. <br> 검색어를 다시 한번 확인해보세요.
			</div>
			</form>
		</div>
		...
		<div class="btn_div m_paging">
			<!-- 모바일에서는 더보기 버튼 노출 -->
			<a href="javascript:" class="btn m_btn" id="btnMore"
				style="display: none">더보기
				<p class="num"></p>
			</a>
		</div>
		<!-- 2021-11-08 배너 추가 -->
		<a href="https://acebed.com/board/event/view.do?detailsKey=30"
			target="_blank" class="review_event"> <img
			src="https://www.acebed.com/common/images/review-event-banner.jpg"
			class="only_web"
			alt="에이스침대 구매 고객 대상 이벤트 - 리뷰쓰고 선물받자 - 에이스침대 제품을 구매하고 후기를 작성하면 푸짐한 선물을 드립니다." />
			<img
			src="https://www.acebed.com/common/images/m-review-event-banner.jpg"
			class="only_mob"
			alt="에이스침대 구매 고객 대상 이벤트 - 리뷰쓰고 선물받자 - 에이스침대 제품을 구매하고 후기를 작성하면 푸짐한 선물을 드립니다." />
		</a>
		<!-- // 2021-11-08 배너 추가 -->
