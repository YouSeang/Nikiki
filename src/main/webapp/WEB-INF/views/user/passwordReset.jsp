...
<meta property="og:url"
	content="http://www.acebed.com:80/member/search/index.do?type=pwd"
	id="og-url-value" />
	...
	<div id="wrap">
		<div id="content" data-swiftype-name="body" data-swiftype-type="text"
			...
			<div class="subCon">
				...
				<div class="head_div">
					<h2 class="titleH1">비밀번호 찾기</h2>
				</div>
				<div class="content_div"
					data-controller="controller/mb/mba/MBAMemberSearchIndexCtrl">

					<input type="hidden" class="notRequired" id="type" name="type"
						value="pwd" />
					<div class="member_area tab_type">
						<div class="tap_style_div">
							<a href="javascript:" class="top_btn on searchTab" id="tabId"
								data-type="id">비밀번호 찾기</a>
						</div>
						<div class="member_box">
							<div class="title searchTxtDiv">
								가입 당시 입력한 정보를 통해 <br> 비밀번호를 찾을 수 있습니다.
								<div class="sub_title">※ SNS를 통해 가입한 회원은 비밀번호 찾기를 할 수
									없습니다.</div>
							</div>
							<form id="passwordResetForm" action="./findPassword"
								...
								<div class="btn_div">
									<input type="submit" class="btn btn1 btnSearch" value="확인">
	...
	<div class="quick_area" data-swiftype-index="false">
		<div class="quick_con">
			<div class="like_div" style="display: none">
				...
				<form action="" data-csrf-key="136g91J6Gq67h0LbVoYP">
