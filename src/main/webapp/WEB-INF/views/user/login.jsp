...
<meta property="og:url"
	content="http://www.acebed.com:80/member/login/index.do?rtnUrl=%2Fboard%2Fevent%2Flist.do"
	id="og-url-value" />
				...
				<div class="member_area">
					<div class="member_box">
						...
						<div class="member_util">
							<p class="chk_txt">
								<input type="checkbox" class="notRequired" id="saveId"
									name="saveId" value="Y" title="아이디 저장"> <label
									for="saveId">아이디 저장</label>
							</p>
							<a href="/member/search/index.do" class="txt_btn"><span>아이디/비밀번호
									찾기</span></a>
						</div>
						<div class="btn_div">
