...
<meta property="og:url"
	content="http://www.acebed.com:80/member/search/index.do"
	id="og-url-value">
...
<link rel="icon" type="image/png" sizes="32x32"
	href="/common/images/favicon/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16"
	href="/common/images/favicon/favicon-16x16.png">
<link rel="manifest" href="/common/images/favicon/site.webmanifest">
<link rel="mask-icon"
	href="/common/images/favicon/safari-pinned-tab.svg" color="#5bbad5">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-config"
	content="/common/images/favicon/browserconfig.xml">
<meta name="theme-color" content="#ffffff">


<link rel="stylesheet" href="/common/js/lib/jquery/jquery-ui.css">
<link rel="stylesheet"
	href="/common/js/lib/datetimepicker/jquery.datetimepicker.css">
...
<script type="text/javascript" async=""
	src="https://www.googletagmanager.com/gtag/js?id=G-9DZP1N4254&amp;cx=c&amp;_slc=1"></script>
<script async="" src="//www.google-analytics.com/analytics.js"></script>
<script type="text/javascript"
	src="/common/js/lib/jquery/jquery.1.12.4.js"></script>
<script type="text/javascript" src="/common/js/lib/jquery/jquery-ui.js"></script>
<script type="text/javascript"
	src="/common/js/jquery.mCustomScrollbar.js"></script>
...
<script type="text/javascript"
	src="/common/js/lib/datetimepicker/jquery.datetimepicker.js"></script>
<script type="text/javascript"
	src="/common/js/lib/jquery/jquery.paging.js"></script>
<script type="text/javascript" src="/common/js/lib/clipboard.min.js"></script>
<script type="text/javascript"
	src="/common/js/controller/co/COCmmCtrl.js"></script>
<script type="text/javascript"
	src="/common/js/controller/co/COMsgCtrl.js"></script>
<script type="text/javascript"
...
@font-face {
	...
	font-display: block;
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-solid-900.eot);
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-solid-900.eot?#iefix)
...
@font-face {
	...
	font-display: block;
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-brands-400.eot);
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-brands-400.eot?#iefix)
		format("embedded-opentype"),
...
@font-face {
	...
	font-display: block;
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-regular-400.eot);
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-regular-400.eot?#iefix)
		format("embedded-opentype"),
...
@font-face {
	...
	font-display: block;
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-v4deprecations.eot);
	src:
		url(https://ka-f.fontawesome.com/releases/v5.15.4/webfonts/free-fa-v4deprecations.eot?#iefix)
		format("embedded-opentype"),
...
.fa.fa-xing, .fa.fa-xing-square, .fa.fa-youtube, .fa.fa-youtube-play,
...
.fa.fa-adn, .fa.fa-bitbucket, .fa.fa-bitbucket-square, .fa.fa-dropbox,
	.fa.fa-flickr, .fa.fa-instagram, .fa.fa-stack-overflow {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-android, .fa.fa-apple, .fa.fa-dribbble, .fa.fa-foursquare, .fa.fa-gittip,
	.fa.fa-gratipay, .fa.fa-linux, .fa.fa-skype, .fa.fa-trello, .fa.fa-windows
	{
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-delicious, .fa.fa-digg, .fa.fa-drupal, .fa.fa-google, .fa.fa-joomla,
	.fa.fa-pied-piper-alt, .fa.fa-pied-piper-pp, .fa.fa-reddit, .fa.fa-reddit-square,
	.fa.fa-stumbleupon, .fa.fa-stumbleupon-circle, .fa.fa-yahoo {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-cc-amex, .fa.fa-cc-discover, .fa.fa-cc-mastercard, .fa.fa-cc-paypal,
	.fa.fa-cc-stripe, .fa.fa-cc-visa, .fa.fa-google-wallet, .fa.fa-paypal {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-buysellads, .fa.fa-connectdevelop, .fa.fa-dashcube, .fa.fa-forumbee,
	.fa.fa-leanpub, .fa.fa-sellsy, .fa.fa-shirtsinbulk, .fa.fa-simplybuilt,
	.fa.fa-skyatlas {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-chrome, .fa.fa-creative-commons, .fa.fa-firefox, .fa.fa-get-pocket,
	.fa.fa-gg, .fa.fa-gg-circle, .fa.fa-internet-explorer, .fa.fa-odnoklassniki,
	.fa.fa-odnoklassniki-square, .fa.fa-opera, .fa.fa-safari, .fa.fa-wikipedia-w
	{
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-codiepie, .fa.fa-fort-awesome, .fa.fa-mixcloud, .fa.fa-modx, .fa.fa-product-hunt,
	.fa.fa-scribd, .fa.fa-usb {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-bluetooth, .fa.fa-bluetooth-b, .fa.fa-envira, .fa.fa-gitlab, .fa.fa-wheelchair-alt,
	.fa.fa-wpbeginner, .fa.fa-wpforms {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-first-order, .fa.fa-google-plus-official, .fa.fa-pied-piper, .fa.fa-snapchat,
	.fa.fa-snapchat-ghost, .fa.fa-snapchat-square, .fa.fa-themeisle, .fa.fa-viadeo,
	.fa.fa-viadeo-square, .fa.fa-yoast {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
.fa.fa-bandcamp, .fa.fa-eercast, .fa.fa-etsy, .fa.fa-grav, .fa.fa-imdb,
	.fa.fa-ravelry {
	font-family: "Font Awesome 5 Brands";
	font-weight: 400
}
...
<script type="text/javascript" charset="utf-8" async=""
	data-requirecontext="_" data-requiremodule="site"
	src="/common/js/site.js"></script>
<script type="text/javascript" charset="utf-8" async=""
	data-requirecontext="_" data-requiremodule="ezCtrl"
	src="/common/js/lib/ezController/jquery.ez.controller-0.4.0.js?bust=1720063127162"></script>
<script type="text/javascript" charset="utf-8" async=""
	data-requirecontext="_"
	data-requiremodule="controller/mb/mba/MBAMemberSearchIndexCtrl"
	src="/common/js/controller/mb/mba/MBAMemberSearchIndexCtrl.js?bust=1720063127162"></script>
<script type="text/javascript" charset="utf-8" async=""
	data-requirecontext="_" data-requiremodule="ezVald"
	src="/common/js/lib/ezValidation/jquery.ez.validation-1.3.6.js?bust=1720063127162"></script>
</head>
<jsp:include page="../header.jsp" />
<body data-login-flag="N" data-device-type="web"
	data-kakao-key="6f6b5601b844d8e4d8835588b2da67f2"
	data-curt-dt="2024-07-04" style="">
	<div id="wrap">
		<div id="content" data-swiftype-name="body" data-swiftype-type="text"
			...
			<div class="subCon">
				...
				<div class="head_div">
					<h2 class="titleH1">아이디/비밀번호 찾기</h2>
				</div>
				<div class="content_div"
					data-controller="controller/mb/mba/MBAMemberSearchIndexCtrl">
					<form id="passwordResetForm" action="./findPassword" method="post">
						<div class="member_form searchForm">
							<input type="text" class="notRequired searchPwd" name="email"
								title="아이디(e-mail)" placeholder="아이디(e-mail)"
								style="display: none"> <input type="text" name="name"
								title="이름" placeholder="이름" required> <input type="text"
								class="mobileChk" name="phone" title="휴대전화 번호"
								placeholder="휴대전화 번호를 - 없이 입력해주세요." maxlength="13" required>
						</div>
						<div class="result_box searchDiv" style="display: none">
							<span class="searchSpan">abc**@gmail.net</span>
						</div>
						<div class="add_txt inner ta_l">
							<p id="joinCd" style="display: none"></p>
						</div>
						<div class="btn_div">
							<button type="submit" class="btn btn1 btnSearch">
								<span>확인</span>
							</button>
							<a href="/member/login/index.do" class="btn btn1 btnLogin"
								style="display: none"><span>로그인</span></a>
							<div class="flt_div searchBtnDiv" style="display: none">
								<a href="/member/login/index.do" class="btn btn1"><span>로그인</span></a>
								<a href="javascript:" class="btn btn2 btnSearchPwd"><span>비밀번호
										찾기</span></a>
							</div>
						</div>
					</form>
			...
			<div class="side_bts view abs" data-swiftype-index="false">
		...
		<footer id="footer" data-swiftype-index="false">
			<div class="footer_link">
				<a href="/business/overview/index.do">기업정보</a> <a
					href="/etc/policy/use/view.do">이용약관</a> <a
					href="/etc/policy/privacy/view.do" class="priv">개인정보처리방침</a> <a
					href="/etc/new-store/index.do">매장개설안내</a> <a
					href="/etc/special-business/index.do">특판사업</a> <a
					href="/customer/prdct-manual/index.do">고객지원</a> <a
					href="javascript:cmmCtrl.loginCheckPage('/my-page/buy-auth/index.do')">구매인증센터</a>
			</div>
			<p class="registration">(주)에이스침대 / 사업자등록번호 : 129-81-02666</p>
			<!-- 2022-02-15 추가 -->
			<!-- 2021-02-16 수정 -->
			<p class="address">본사 : 경기도 성남시 중원구 사기막골로 105번길 42(상대원동) / 서울영업본부
				: 서울특별시 강남구 도산대로 218 / FAX : 02-544-8788</p>
			<!-- // 2021-02-16 수정 -->

			<p class="copy">
				COPYRIGHT (C) ACE BED <br class="only_mob">CORPORATION ALL
				RIGHTS RESERVED
			</p>
			<div class="link_selec">
				<div class="fam_link_div">
					<div>
						<a href="http://eng.acebed.com" target="_blank">ENGLISH</a> <a
							href="http://www.aceavenue.co.kr" target="_blank">에이스 에비뉴</a> <a
							href="http://www.aceheritz.com" target="_blank">에이스 헤리츠</a> <a
							href="https://acebedmall.co.kr" target="_blank">에이스 침대몰</a>
					</div>
		...
		<div class="quick_area" data-swiftype-index="false">
			<div class="quick_con">
				<div class="like_div" style="display: none">
					...
					<form action="" data-csrf-key="Nb36zXgXVST1uujBD4Oq">
		...
		<div class="layer_pop browser_pop w500"
			style="display: none; height: auto;">
			<div class="pop_title">브라우저 업데이트 안내</div>
			<div class="pop_cont" style="max-height: 740px; height: 788px;">
				<div class="inner_box">
					<div class="txt_box pa_t ta_c">
						<p>
							에이스침대 홈페이지에서는 <br> EDGE 및 크롬 브라우저에서 정상 작동합니다. <br> 본
							홈페이지를 이용하기 위해서는 <span class="fw_l">보안과 속도가 강화된 <br>브라우저로
								업그레이드
							</span> 하기를 권장합니다.
						</p>
					</div>
	...
	<script type="text/javascript" src="/common/js/lib/require.js"
