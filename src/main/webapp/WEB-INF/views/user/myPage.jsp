...
<meta property="og:url"
	content="http://www.acebed.com:80/my-page/member-modify/index.do"
	id="og-url-value" />
...
<script>
	function toggleAuthDiv() {
		var authDiv = document.querySelector(".authHpDiv");
...
<body data-login-flag="Y" data-device-type="web"
	...
	<div id="wrap">
		<header data-swiftype-index="false">
			...
			<div class="utill_div">
				<a href="/member/login/logout.do">로그아웃</a>
				<div class="my_page">
			...
			<nav>
				<div class="gnb_section gnb1">
					...
					<div class="one_dep">
						<div>
							<a href="/product/furnture/roomset/list.do"> <span
								class="one">FURNITURE</span> <span>가구</span>
							</a>
							<div class="two_dep">
								<a href="/product/furnture/roomset/list.do" target="_self"><span>룸
										세트</span></a> <a href="/product/furnture/living/list.do" target="_self"><span>리빙가구</span></a>
							</div>
						</div>
					</div>
					<div class="one_dep">
				...
				<div class="gnb_section gnb2">
					...
					<div class="one_dep">
						<div>
							...
							<div class="two_dep">
								<a href="/ace-story/sns/index.do" target="_self"><span>NOW
				...
				<div class="all_menu_div">
					...
					<div class="visual_menu">
						...
						<div class="pro_menu_list m_acco_menu">
							<div class="menu">
								<p class="img">
									<img src="/common/images/all-menu-visual1.jpg" alt=""
										class="only_web" /> <img
										src="/common/images/m-all-menu-visual1.jpg" alt=""
										class="only_mob" />
								</p>
								<div>
									<div class="one_d">
							...
							<div class="menu">
								<p class="img">
									<img src="/common/images/all-menu-visual2.jpg" alt=""
										class="only_web" /> <img
										src="/common/images/m-all-menu-visual2.jpg" alt=""
										class="only_mob" />
								</p>
								<div>
									<div class="one_d">
							...
							<div class="menu">
								<p class="img">
									<img src="/common/images/all-menu-visual3.jpg" alt=""
										class="only_web" /> <img
										src="/common/images/m-all-menu-visual3.jpg" alt=""
										class="only_mob" />
								</p>
								<div>
									<div class="one_d">
							...
							<div class="menu">
								<p class="img">
									<img src="/common/images/all-menu-visual4.jpg" alt=""
										class="only_web" /> <img
										src="/common/images/m-all-menu-visual4.jpg" alt=""
										class="only_mob" />
								</p>
								<div>
									<div class="one_d">
					...
					<div class="all_menu">
						<div class="m_utill_div">
							<a href="/member/login/logout.do">로그아웃</a> <a href="javascript:"
								class="my_page">마이페이지</a> <a href="https://acebedmall.co.kr"
								target="_blank" class="ace_mall">에이스 침대몰</a>
						</div>
						<div class="search_div">
							<p class="search_input">
								<input type="text" name="searchTerm" title="검색어"
						...
						<div class="m_banner">
							<a href="/member/join/write.do?joinCd=wedding"><img
								src="/common/images/m-wedding-banner.jpg" alt="" /></a>
						</div>
						<div class="lnk_div">
		...
		<div id="content" data-swiftype-name="body" data-swiftype-type="text"
			...
			<div class="subCon">
				...
				<div class="head_div">
					<h2 class="titleH1">회원정보 수정</h2>
				</div>
				<div class="content_div"
					data-controller="controller/mp/mpa/MPAMemberModifyIndexCtrl">

					<div class="member_area">
						<div class="form_inner">
							<p class="title">개인정보 관리</p>
							<div class="form_cont bor_b">
								<div class="form_div">
									<dl>
										<dt>
											<p>
												이름 <strong class="req_input" title="필수입력"></strong>
											</p>
										</dt>
										<dd>
											<p>${user.name}</p>
									...
									<dl>
										<dt>
											<p>
												아이디 <br class="br_m" />(E-mail) <strong class="req_input"
													title="필수입력"></strong>
											</p>
										</dt>
										<dd>
											<p>${user.email}</p>
											<div class="line bor_t">
												<p class="radio_txt">
													<input type="radio" id="emailAgmntY" name="emailAgmnt"
														value="Y" title="이메일 수신 동의" /> <label for="emailAgmntY">수신</label>
												</p>
												<p class="radio_txt">
													<input type="radio" id="emailAgmntN" name="emailAgmnt"
														value="N" title="이메일 수신 동의" checked="checked" /> <label
														for="emailAgmntN">수신 안함</label>
												</p>
												<div class="add_txt">
													<p>※ 에이스침대의 다양한 정보를 이메일로 보내 드립니다.</p>
												</div>
												<input type="hidden" class="notRequired"
													name="infoEmailAgmnt" value="N">
											</div>
										</dd>
									</dl>
									<dl class="pa_t60">
										<dt>
											<p>
												휴대폰 <strong class="req_input" title="필수입력"></strong>
											</p>
										</dt>
										<dd>
											<div class="flt_div">
												<p>${user.phone_number}</p>
												<a href="javascript:void(0);" class="input_btn btnHpChg"
													onclick="toggleAuthDiv()"> <span>휴대폰 번호 변경</span>
												</a>
											</div>
											<div class="line bor_t">
												<p class="radio_txt">
													<input type="radio" id="smsAgmntY" name="smsAgmnt"
														value="Y" title="SMS 수신 동의" /> <label for="smsAgmntY">수신</label>
												</p>
												<p class="radio_txt">
													<input type="radio" id="smsAgmntN" name="smsAgmnt"
														value="N" title="SMS 수신 동의" checked="checked" /> <label
														for="smsAgmntN">수신 안함</label>
												</p>
												<div class="add_txt">
													<p>※ 각종 신청 정보를 SMS로 보내 드립니다</p>
												</div>
												<input type="hidden" class="notRequired" name="infoSmsAgmnt"
													value="N">
											</div>
											<div class="ip_box flt_div authHpDiv" style="display: none;">
												<form action="./numberUpdate" method="post">
													<input type="text" class="mobileChk notRequired" id="hpNo"
														name="newPhoneNumber" title="휴대전화 번호" placeholder=""
														maxlength="13"> <input type="hidden"
														class="notRequired" name="hpNoChkVal">
													<button type="submit" class="input_btn btnHpAuth">
														<span>변경하기</span>
													</button>
												</form>
											</div>
						...
						<div class="btn_div inner">
							<a href="./main" class="btn btn1 btnSubmit"><span>홈 화면</span></a>
						</div>
						<div class="form_inner noPT">
							<div class="table_box">
								<div class="left_d">
									<p>회원탈퇴</p>
								</div>
								<div class="right_d">
									<p class="dot_tit">회원 탈퇴를 원하시면 탈퇴하기 버튼을 눌러주세요.</p>
									<ul class="dot_list">
										<li>&middot; 탈퇴 시 개인정보는 완전히 삭제되어 복구가 불가능합니다.</li>
										<li>&middot; 구매후기 및 상담내역 등의 정보는 남아 있으니 모두 직접 삭제 후 탈퇴해주세요.</li>
				...
				<!-- 비밀번호 작성 규칙 안내 팝업 -->
				<div class="layer_pop text_type w500" style="height: auto;">
				...
				<script type="text/javascript"
					src="/common/js/lib/datetimepicker/jquery.datetimepicker.ko.js"></script>
			</div>
		...
		<div class="quick_area" data-swiftype-index="false">
			<div class="quick_con">
				<div class="like_div" style="display: none">
					...
					<form action="" data-csrf-key="f7kZD5AWeNHgNVInczBu">
