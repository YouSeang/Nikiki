...
<html lang="ko">
    <head>
        ...
        <meta property="og:url" content="http://www.acebed.com:80/experience/move/write.do?type=personal" id="og-url-value" />
        ...
        <meta itemprop="url" content="http://www.acebed.com:80/experience/move/write.do?type=personal" id="schema-url-value" />
			...
			<div class="sub_vis window_load">
					...
					<div class="content_div" data-controller="controller/ce/cea/CEAMoveIndexCtrl">
						<div id="write_area">
							...
							<!-- 2023-06-01 추가 -->
							<div class="tap_style_div ctab">
								<div class="inner">
									<div class="swiper-container">
										<div class="swiper-wrapper">
											<div class="swiper-slide tab_top"><a href="javascript:" class="top_btn tabType" data-type="AREA_CD_09">수도권</a></div>
												<div class="swiper-slide tab_top"><a href="javascript:" class="top_btn tabType" data-type="AREA_CD_08">부산 · 경남</a></div>
												</div>
									</div>
								</div>
							</div>
        ...
        <div class="custom_scroll">
            <div class="pop_inner">
                <form id="moveWritePerson" name="moveWritePerson" method="post" action="insert">
                    ...
                    <input type="hidden" class="notRequired" id="csrfKey" name="csrfKey" value="tkLo5HeYLjOP4gbyGg6X" />

                    <div class="form_inner">
                        <div class="form_cont">
                            <div class="exp_div">
                                <p class="tit">서비스 신청 매장</p>
                                <div class="exp_top">
                                    <p class="tit" id="storeNm"></p>
                                </div>
                            </div>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="select_box">
                                                    <select id="hopeDt" name="hopeDt" class="selectBox hopeDt" title="방문 희망 일정">
</select>
                                                </div>
                                            </dd>
                                        </dl>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="select_box lSpan">
                                                    <select name="searchKey" id="year" class="form-control selectBox w30" title="생년월일">
                                                    ...
                                                    <select name="searchKey" id="month" class="form-control selectBox w30" title="생년월일">
                                                    ...
                                                    <select name="searchKey" id="date" class="form-control selectBox w30" title="생년월일">
                            ...
                            <div class="borT">
                                <div class="exp_div exp_agree_div">
                                    <div>
                                        <p class="tit">이동수면공학연구소 체험을 위한 개인정보 수집 이용 동의 <strong class="req_input" title="필수입력"><img src="/common/images/req-input-icon.png" alt="필수입력"></strong></p>
                                    </div>
                                ...
                                <div class="exp_div exp_agree_div">
                                    <div>
                                        <p class="tit">이동수면공학연구소 체험을 위한 개인정보 3자 제공 이용 동의 <strong class="req_input" title="필수입력"><img src="/common/images/req-input-icon.png" alt="필수입력"></strong></p>
                                    </div>
                                    <p class="chk_txt only_pc">
			...
			<div class="quick_area" data-swiftype-index="false">
            	<div class="quick_con">
                	<div class="like_div" style="display:none">
                    	...
                    	<form action="" data-csrf-key="tkLo5HeYLjOP4gbyGg6X">
