						...
						<div class="pro_content">
							<div id="dataAreaY" style="">
								<div class="list_type4 square motion_list " id="listArea">
									<div class="list active" data-total-record-count="106"
										data-total-page-count="9">

										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 180, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper180" data-seq="180" seq="180">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2022/5/22053002564577142340.jpg" alt=""
															id="img180"></span>
													</div>
												</div>
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct  on"
												data-intrs-prdct="frame_180" data-action="insert">찜하기</a>
											<p class="value">K</p>
											<p class="tit">FOGLIA</p>
											<p class="txt">A Type</p>

											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #e0dcd3"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
															<p class="txt">그레이화이트</p>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 214, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper214" data-seq="214" seq="214">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23072712035725017992.jpg" alt=""
															id="img214"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_214" data-action="insert">찜하기</a>
											<p class="value">SS</p>
											<p class="tit">ERICA</p>
											<p class="txt">N Type</p>

											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #e3dca4"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 210, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper210" data-seq="210" seq="210">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23070610102775307625.jpg" alt=""
															id="img210"></span>
													</div>
													<div class="swiper-slide swiper-slide-next"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23070610102772217279.jpg" alt=""
															id="img210"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_210" data-action="insert">찜하기</a>
											<p class="value">LK / K</p>
											<p class="tit">ARNO-Ⅱ</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('210', '/image/2023/7/23070610102775307625.jpg', '0')"
														style="position: relative">
														<span style="background: #f4d097;"></span>
													</p>
												...
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('210', '/image/2023/7/23070610102772217279.jpg', '1')"
														style="position: relative">
														<span style="background: #574529;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 168, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper168" data-seq="168" seq="168">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2024/1/24010503004570651565.jpg" alt=""
															id="img168"></span>
													</div>
													<div class="swiper-slide swiper-slide-next"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2024/1/24010503004573585268.jpg" alt=""
															id="img168"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct  on"
												data-intrs-prdct="frame_168" data-action="insert">찜하기</a>
											...
											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('168', '/image/2024/1/24010503004570651565.jpg', '0')"
														style="position: relative">
														<span style="background: #e6d5b5;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
												...
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('168', '/image/2024/1/24010503004573585268.jpg', '1')"
														style="position: relative">
														<span style="background: #5d402e;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
															<p class="txt">콜롬비아월넛</p>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 219, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper219" data-seq="219" seq="219">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/9/23092609124638149234.jpg" alt=""
															id="img219"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct  on"
												data-intrs-prdct="frame_219" data-action="insert">찜하기</a>
											<p class="value">K / LQ</p>
											...
											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #d1baac"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 155, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper155" data-seq="155" seq="155">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2021/2/21020501484938427806.jpg" alt=""
															id="img155"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_155" data-action="insert">찜하기</a>
											<p class="value">LK / K / LQ</p>
											<p class="tit">LANOTTE</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #9d9191"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 187, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper187" data-seq="187" seq="187">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2021/10/21101503335301499631.jpg" alt=""
															id="img187"></span>
													</div>
													<div class="swiper-slide swiper-slide-next"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23070610210643060584.jpg" alt=""
															id="img187"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_187" data-action="insert">찜하기</a>
											<p class="value">LK / K / LQ</p>
											<p class="tit">BMA1164</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('187', '/image/2021/10/21101503335301499631.jpg', '0')"
														style="position: relative">
														<span style="background: #cdc1a7;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
												...
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('187', '/image/2023/7/23070610210643060584.jpg', '1')"
														style="position: relative">
														<span style="background: #797876;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 119, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper119" data-seq="119" seq="119">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2021/2/21022302274880162656.jpg" alt=""
															id="img119"></span>
													</div>
													<div class="swiper-slide swiper-slide-next"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23070610230472380920.jpg" alt=""
															id="img119"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_119" data-action="insert">찜하기</a>
											<p class="value">LK / K / LQ</p>
											<p class="tit">BRA1439</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('119', '/image/2021/2/21022302274880162656.jpg', '0')"
														style="position: relative">
												...
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('119', '/image/2023/7/23070610230472380920.jpg', '1')"
														style="position: relative">
														<span style="background: #ffffff;"></span>
													</p>
													<div class="info">
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 176, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper176" data-seq="176" seq="176">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2021/2/21022412214778470914.jpg" alt=""
															id="img176"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_176" data-action="insert">찜하기</a>
											<p class="value">LK / K / LQ</p>
											<p class="tit">OPIMO-II</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #cec2b3"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 166, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper166" data-seq="166" seq="166">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2021/2/21020501521176391145.jpg" alt=""
															id="img166"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_166" data-action="insert">찜하기</a>
											<p class="value">LQ</p>
											<p class="tit">OPALO</p>
											<p class="txt">N Type</p>
											...
											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('166', '/image/2021/2/21020501521176391145.jpg', '0')"
														style="position: relative">
														<span style="background: #58595d;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
												...
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #9d8d80"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 188, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper188" data-seq="188" seq="188">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2022/3/22033006313666402993.png" alt=""
															id="img188"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_188" data-action="insert">찜하기</a>
											<p class="value">LQ</p>
											<p class="tit">BMA1165</p>
											<p class="txt">L/C Type</p>

											<div class="color_div">
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #624233"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
												...
												<div class="color_chip""="">
													<p class="color" href="javascript:">
														<span style="background: #ac8e68"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
									...
									<div class="list active" data-total-record-count="106"
										...
										<a href="javascript:"
											onclick="cmmCtrl.details('detailsKey', 197, './view.do')"
											class="img" style="height: 284px;">
											<div class="swiper swiper-container-horizontal"
												id="swiper197" data-seq="197" seq="197">
												<div class="swiper-wrapper"
													style="transform: translate3d(0px, 0px, 0px);">
													<div class="swiper-slide swiper-slide-active"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2022/10/22102511565353111864.jpg" alt=""
															id="img197"></span>
													</div>
													<div class="swiper-slide swiper-slide-next"
														style="width: 284px; height: 284px; margin-right: 10px;">
														<span class="frame_img"><img
															src="/image/2023/7/23072004222292302690.jpg" alt=""
															id="img197"></span>
													</div>
												</div>
												<span class="swiper-notification" aria-live="assertive"
										...
										<div class="text_div">
											<a href="javascript:" class="like btnIntrsPrdct "
												data-intrs-prdct="frame_197" data-action="insert">찜하기</a>
											<p class="value">LQ</p>
											<p class="tit">BMA1167</p>
											<p class="txt">T Type</p>

											<div class="color_div">
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('197', '/image/2022/10/22102511565353111864.jpg', '0')"
														style="position: relative">
														<span style="background: #654d42;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
															<p class="txt">버지니아월넛</p>
														</div>
													</div>
												</div>
												<div class="color_chip" style="cursor: pointer;""="">
													<p class="color" href="javascript:"
														onmouseover="fnChangeTnlImg('197', '/image/2023/7/23072004222292302690.jpg', '1')"
														style="position: relative">
														<span style="background: #ffe8cc;"></span>
													</p>
													<div class="info">
														<div>
															<p class="color"></p>
