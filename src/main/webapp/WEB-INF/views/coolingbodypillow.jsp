...
<html lang="ko">
    <head>
		...
		<title>
			쿨링 바디필로우 | SLEEP CARE | 에이스침대</title>
        ...
        <meta property="og:url" content="http://www.acebed.com:80/product/sleep-care/coolingbodypillow/index.do" id="og-url-value" />
        <meta property="og:image" content="http://www.acebed.com:80/common/images/sns-share-thumbnail.jpg" id="og-image-value" />
        	<meta property="og:title" content="쿨링 바디필로우" id="og-title-value" />
        	<meta property="og:description" content="에이스침대의 공식 홈페이지 입니다." id="og-description-value" />

        <meta itemprop="url" content="http://www.acebed.com:80/product/sleep-care/coolingbodypillow/index.do" id="schema-url-value" />
		...
		<meta class="swiftype" name="child_menu" data-type="string" content="쿨링 바디필로우" />
		<meta class="swiftype" name="title" data-type="string" content="슬립케어 > 쿨링 바디필로우" />
...
<!-- Google tag (gtag.js) -->
            ...
            <div class="window_load">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gry_box">
                            <span><img src="https://www.acebed.com/common/images/PRO-007-07_sample.jpg" alt=""></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="subinfo_area scroll_motion">
        <div class="inner">
            <p class="title">한여름 밤의 쿨, <br class="only_mob"> 쿨링 바디필로우</p><!-- 2024-05-22 수정 -->
            <p class="descrip">
                쿨링 바디필로우는 일반 아이스 원단과는 비교되지 않는 <br class="only_web" />
                두툼한 중량감과 쿨링감은 물론, 3중직 원단으로 시원하고 푹신합니다.
            </p>
        </div>
    </div>
    ...
    <div class="micro_cooling_view">
        <div class="micro_cooling_div1">
            <div class="micro_cooling_feature1">
                <img src="https://www.acebed.com/common/images/PRO-007-07_viewimg1.jpg" />
                <div class="desc_wrap">
                    <div class="desc">
                        <p class="txt_tit">
                        ...
                        <p class="txt_desc only_web">
                            죽부인에서 영감 받은 형태와 디자인으로 <br />
                            쿨링감을 바로 느낄 수 있으며, <br />
                            3중직 냉감원단으로 두께감과 안정성을 갖췄습니다.
                        </p>
            ...
            <div class="micro_cooling_feature2">
                <img src="https://www.acebed.com/common/images/PRO-007-07_viewimg2.jpg" />
                <div class="desc_wrap">
                    <div class="desc">
                        <p class="txt_tit">
                            높은 탄성과 부드러운 촉감으로 <br />
                        ...
                        <p class="txt_desc only_web">
                            마이크로케어 원단과 동일 원단(웰로쉬)을 사용하여 <br />
                            부드러운 감촉과 알러지 방지 기능이 있습니다.
                        </p>
                        <p class="txt_desc only_mob">
                            마이크로케어 원단과 동일 원단(웰로쉬)을 사용하여 <br />
                            부드러운 감촉과 알러지 방지 기능이 있습니다.
            ...
            <div class="micro_cooling_feature3">
                <img src="https://www.acebed.com/common/images/PRO-007-07_viewimg3.jpg" />
                <div class="desc_wrap">
                    <div class="desc">
                        <p class="txt_tit">
                            커버 교체가 편리한 지퍼 형태,<br />
                        ...
                        <p class="txt_desc only_web">
                            지퍼 형태로 되어 있어 사계절 커버 교체가 쉬우며, <br />
                            세탁이 용이합니다.
                        </p>
                        <p class="txt_desc only_mob">
                            지퍼 형태로 되어 있어 사계절 커버 교체가 쉬우며, <br />
        ...
        <div class="micro_cooling_div2">
            <p class="txt scroll_motion">
                <strong>쿨링 바디필로우 원단이 건강한 수면을 약속합니다.</strong>
                <span class="only_web">
        ...
        <div class="micro_cooling_div4 swiper-container">
            <dl>
                <dt>제품 구성</dt>
                <dd>쿨링 바디필로우 1EA(쿨링 커버 + 솜) + 사계절용 커버 1EA (교체용)</dd>
                ...
                <dd>
                    <div class="laundry_notice">
                        ...
                        <div class="notice_desc">
                            <p class="txt_tit">쿨링 바디필로우 세탁 시 주의사항</p>
                            <p class="txt_desc only_web">
                                쿨링 바디필로우 원단은 열전도성 높은 특수 원사를 사용한 냉감 섬유입니다. 반드시 찬물 세탁을 권장하며, 고온 세탁 및 건조 시 수축 변형 변색이 있을 수 있습니다. <br />
                                특히, 소재의 특성상 열에 약하므로 건조기 사용을 금지하여 주시기 바랍니다.
                            </p>
                            <p class="txt_desc only_mob">
                                쿨링 바디필로우  원단은 열전도성 높은 특수 원사를 사용한 <br />
                    ...
                    <ul class="how_to_wash">
                        ...
                        <li>
                            <div>
                                <img src="/common/images/PRO-007-06_icon3.png" />
                                <p class="txt_tit">충분히 침지 후 세탁</p>
                                <p class="txt_desc">
                                    바디필로우를 충분히 잠기게 한 후 <br />
                                    세탁망을 이용해 세탁하면 <br />
                                    원단 손상이 예방됩니다.
                                </p>
                            </div>
			...
			<div class="quick_area" data-swiftype-index="false">
            	<div class="quick_con">
                	<div class="like_div" style="display:none">
                    	...
                    	<form action="" data-csrf-key="YukDxQQoRFRWCNgrE2Wp">
